...
def equation24(k,l2,d,d1,d2,m,e1,b1):
    ...
    # print("\n \n in equation24 s2 = {0}  s3 = {1}".format(s2,s3))
    ...
    l3 = l2*d1+(d1//4)
    l4 = l2*d1+3*(d1//4)
    # print("\n \n in equation24  l3 = {0}  l4 = {1}".format(l3,l4))
    g1 = exp1(l3*l3,g,p)
    g2 = exp1(l4*l4,g,p)
    t1 = a3[0]*g1%p
    t2 = a4[0]*g2%p
    t3 = (t1+(p-1)*t2)%p
    # print("\n \n in equation24  t1 = {0}  t2 = {1}".format(t1,t2))
    # print("\n \n in equation24 t3 = ",t3)
    t1 = a3[1]*g1%p
    t2 = a4[1]*g2%p
    t4 = (t1+t2)%p
...
def equation24v2(k,l2,d,d1,d2,m,e1,b1):
    g = k.g
    a2 = k.a2
    i2 = k.i2
    p = k.p
...
def equation26v3(k,l2,d,d1,m,flag):
    ...
    a3 = exp2a(t1,a2,p)
    a4 = exp2a(l2,a3,p)
    mult25(m,a4[0],a4[1],35,36,40,p)
    
    if flag==1:        
        print("\n \n in equation26v3")
        t1 = 2*d[0]+2*d[1]
        h1 = series23(-d4,d4,d1,k.g,k.a2,abs(t1),1,p)
        t2 = (a4[0]*h1[0]+a4[1]*h1[1])%p
        print("\n \n ({0}, {1}, {2}) t1 = {3}   h1 = {4}   t2 = {5}".format(-d4,d4,d1,t1,h1,t2))
...
def equation38v4(k,l2,d,d1,d2,m,e1,b1):
    g = k.g
    a2 = k.a2
    i2 = k.i2
    p = k.p
...
def init25(g,l2,d,d1,h1,h2,p,flag):
    ...
    if (d[0]==t1):    
        d2 = [2]    
        equation24v2(k,l2,d,d1,d2,m,17,b1)
        d2 = [4]
        equation24v2(k,l2,d,d1,d2,m,20,b1)

    if (d[0]==9*t1):    
        d2 = [2]    
        equation38v4(k,l2,d,d1,d2,m,17,b1)
        d2 = [4]
        equation38v4(k,l2,d,d1,d2,m,20,b1)  

    # y1,y2 = equation26v4(k,l2,d,d1,m,flag)
    
    y1,y2 = equation26v3(k,l2,d,d1,m,flag)

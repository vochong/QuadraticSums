...
def init50(g,a2,l2,d,d7,d1,h,p,e1,flag):

    # 1
    h1 = h[0]
    h2 = h[1]
    m1,b1 = init25(g,l2,d,d1,h1,h2,p,flag)
    if flag==1:
        k = series(g,p)
    ...
    h2 = h[3]
    l3 = l2+1
    m2,b2 = init25(g,l3,d,d1,h1,h2,p,flag)
    if flag==1:
        k = series(g,p)
    ...
    """
    t1 = inverse(s3[1],p)*s3[3]%p
    t2 = inverse(s3[1],p)*s3[5]%p
    if flag==1:
        print("\n \n ^^^^^^^^^^^^^^^^^    in init75 t1 = ",t1,"   t2 = ",t2)
        print("\n \n")
    """

    return(s1,s2,s3)

def init50v2(g,a2,l2,d,d7,d1,h,p,e1,flag):
    ...
    b = m7[36]
    t9 = multcnvl2(h1,a,p)
    t10 = multcnvl2(h1,b,p)
    if flag==1:
        print("\n \n t9 = {0}  t10 = {1}".format(t9,t10))
        print("\n \n y1[35] = ",y1[35],"  y1[36] = ",y1[36])
    s3[0] = t9
    s3[1] = t10

    a = m7[37]
    b = m7[38]
    t11 = multcnvl2(h1,a,p)
    t12 = multcnvl2(h1,b,p)
    if flag==1:
        print("\n \n t11 = {0}  t12 = {1}".format(t11,t12))
        print("\n \n y1[37] = ",y1[37],"  y1[38] = ",y1[38])
    s3[2] = t11
    s3[3] = t12
...
# test 1
m4,b4 = init25(g,l2,d,d1,h3,h4,p,1)
...
print("\n \n \n \n   d = ",d,"   d7 = ",d7)
l3 = l2+1
h[2] = k.series24(-l3,l3,[d7[0]],d2)
h[3] = k.series24(-l3,l3,[d7[1]],d2)


e1 = [1,0]
s1,s2,t3 = init50(g,k.a2,l2,d,d7,d1,h,p,e1,1)
print("\n \n from init50 s1 =",s1,"  s2 =",s2)
print("\n \n from init50 t3 =",t3)


e1 = [0,0]
s1,s2,t1,t2 = init50v2(g,k.a2,l2,d,d7,d1,h,p,e1,0)
print("\n \n from init50v2 s1 =",s1,"  s2 =",s2)
print("\n from init50v2 t1 =",t1,"  t2 =",t2)

e1 = [1,0]
s3,s4,t3,t4 = init50v2(g,k.a2,l2,d,d7,d1,h,p,e1,0)
print("\n \n from init50v2 s3 =",s3,"  s4 =",s4)
print("\n from init50v2 t3 =",t3,"  t4 =",t4)

l4 = l2*(2*d[0]+2*d[1])
a3 = exp2a(l4,k.a2,p)
t = (t3[0]**2+t3[1]**2)%p
t = sqrt1(t,p)
a4 = [inverse(t,p)*t3[0]%p , inverse(t,p)*t3[1]%p]
a6 = [inverse(a3[0],p)*t3[0]%p , inverse(a3[1],p)*t3[1]%p]
print("\n t =",t,"   a4 =",a4,"  a6 = ",a6)
...
t = (t4[0]**2+t4[1]**2)%p
t = sqrt1(t,p)
a5 = [inverse(t,p)*t4[0]%p , inverse(t,p)*t4[1]%p]
a7 = [inverse(a3[0],p)*t4[0]%p , inverse(a3[1],p)*t4[1]%p]
print("\n t =",t,"   a5 =",a5,"  a7 =",a7)

e1 = [0,1]
s5,s6,t5,t6 = init50v2(g,k.a2,l2,d,d7,d1,h,p,e1,0)
print("\n \n from init50v2 s5 =",s5,"  s6 =",s6)
print("\n from init50v2 t5 =",t5,"  t6 =",t6)


s4[:] = s6

for i in range(4):
    s3[i] = (s3[i]+(p-1)*s1[i])%p
    s4[i] = (s4[i]+(p-1)*s2[i])%p

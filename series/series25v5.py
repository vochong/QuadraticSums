...
def init50(g,a2,l2,d,d7,d1,h,p,flag):
    ...
    m2,b2 = init25(g1,l3,d7,d1,h1,h2,p)
    if flag==1:
        k = series(g1,p)
        print("\n \n in init50 (2) k.i2 = ",k.i2)
        k26 = series25(-l3,l3,k.g,k.a2,k.i2,d7,d1*d1,p)
...
def equation27(k,l2,d,d1,m):
    ...
    t1 = 2*1520%p
    t2 = 2*1237%p
    mult25(m,t1,t2,25,26,45,p)
    # mult25(m,1,p-1,45,27,23,p)
    

    c = 2*d[0]+2*d[1]
    print("\n\n in e27 l2 = {0} c = {1} d = {2} d1 = {3}".format(l2,c,d,d1))

    # 1
    t1 = l2
    k1 = series4(g,t1,[c],d1,p)
    k1.l2 = l2
    k1.series = init2(5)
    k1.adjust(-4*d[0])
    # k1.adjust(-1152)
    print("\n \n in equation27 (1) k1.series = ",k1.series)
    print()
    k1.variables()
    ...
    t2 = (p+1)//2
    t3 = p-t2
    k1.series = [t2,0,0,0,t3]
    k1.adjust(-4*d[0])
    print("\n \n in equation27 (2) k1.series = ",k1.series)
    ...
    t2 = (p+1)//2
    t3 = t2*t2%p    
    k1.series = [0,t3,0,t3,0]
    k1.adjust(-4*d[0])
    print("\n \n in equation27 (3) k1.series = ",k1.series)
...
k = series4(g,17+2,[4160],8,p)
k1 = series4(g,17+2,[4160-1152],8,p)
...
t1 = -1152
k.adjust(t1)
print("\n \n k.adjust({0}) = {1}".format(t1,k.series))
print("\n \n k1.series = ",k1.series)

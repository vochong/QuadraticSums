...
def init25(g,l2,d,d1,h1,h2,p):
    ...
    if (d[0]==9*t1):    
        d2 = [2]    
        equation38(k,l2,d,d1,d2,m,17,b1)
        d2 = [4]
        equation38(k,l2,d,d1,d2,m,20,b1)
...
def init125(g,g1,g2,l2,d,d1,h,p,flag):
    ...
    if (t1==2) and (t2==1):
        ...
        m7[2][4] = 1015*m7[2][4]%p

        m7[3][0] = 1*m7[3][0]%p
        m7[3][1] = 1457*m7[3][1]%p
        m7[3][2] = 1015*m7[3][2]%p
        m7[3][3] = 1457*m7[3][3]%p
        m7[3][4] = 1457*m7[3][4]%p
        
        m7[4][0] = 1*m7[4][0]%p
        m7[4][1] = 1457*m7[4][1]%p
        m7[4][2] = 1015*m7[4][2]%p
        m7[4][3] = 1457*m7[4][3]%p
        m7[4][4] = 1457*m7[4][4]%p
...
h[10] = k3.series24(-l2,l2,[d[0]],d2)
h[11] = k3.series24(-l2,l2,[1*e1+d[1]],d2)
...
e1 = 16*3*(d[0]+d[1])//(2*d1)
a3 =  exp2a(e1,k.a2,p)
print("\n \n a3 = ",a3)

e2 = 32*1*(d[0]+d[1])//(2*d1)
a4 =  exp2a(e2,k.a2,p)
print("\n \n a4 = ",a4)

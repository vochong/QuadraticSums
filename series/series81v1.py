...
def equation21(k,l2,d,d1,d2,m,e1,b1):
    ...
    t1 = d2[0]*d[1]
    # h1 = series23(-20,20,4,k.g,k.a2,t1,1,p)
    h1 = series23(-l3+2,l3+2,d1,k.g,k.a2,t1,1,p)
    print("\n \n in equation21 t1 = ",t1,"   h1 = ",h1)

    g1 = exp1(l3*l3,g,p)
    g2 = exp1((l3-2)*(l3-2),g,p)
...
def equation22(k,l2,d,d1,d2,m,e1,b1):
    ...
    t1 = d2[0]*d[0]-d2[1]*d[1]
    # h1 = series23(-20,20,4,k.g,k.a2,t1,1,p)
    h1 = series23(-l3+2,l3+2,d1,k.g,k.a2,abs(t1),1,p)
    print("\n \n in equation22 t1 = ",t1,"   h1 = ",h1)
...
l2 = 5
d1 = 16
k81 = series27(-l2,l2,k.g,k.a2,k.i2,d,d1,p)
...
d1 = 4
d2 = [2,8]
equation20(k,l2,d,d1,d2,m,20,b1)
"""
...
for i in range(16):
    d2 = d3[i]
    equation20(k,l2,d,d1,d2,m,2*i+17,b1)

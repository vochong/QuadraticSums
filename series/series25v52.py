...
def init75(g,g1,g2,a2,l2,d,d7,d1,h,p,e1,flag):
    ...
    m2,b2 = init25(g1,l3,d,d1,h1,h2,p,flag)
    if flag==1:
        k = series(g1,p)
        print("\n \n in init75 (2) k.i2 = ",k.i2)
    ...
    h2 = h[5]
    l3 = l2+0    
    m3,b3 = init25(g2,l3,d,d1,h1,h2,p,flag)
    
    if flag==1:
        k = series(g2,p)
        print("\n \n in init75 (3) k.i2 = ",k.i2)
        k27 = series25(-l3,l3,k.g,k.a2,k.i2,d,d1*d1,p)
        
        y3 = init2(50)
        for i in range(50):
            y3[i] = multcnvl2(m3[i],k27,p)
...
def init75v2(g,g1,g2,a2,l2,d,d7,d1,h,p,e1,flag):
...
h[4] = k2.series24(-l3,l3,[d7[0]],d2)
h[5] = k2.series24(-l3,l3,[d7[1]],d2)

e1 = [1,0]
s1,s2,t3 = init75(g,g1,g2,k.a2,l2,d,d7,d1,h,p,e1,1)
print("\n \n from init75 s1 =",s1,"  s2 =",s2)
print("\n \n from init75 t3 =",t3)


e1 = [0,0]
s1,s2 = init75v2(g,g1,g2,k.a2,l2,d,d7,d1,h,p,e1,0)
print("\n \n from init75v2 s1 =",s1,"  s2 =",s2)

e1 = [1,0]
s3,s4 = init75v2(g,g1,g2,k.a2,l2,d,d7,d1,h,p,e1,0)
print("\n \n from init75v2 s3 =",s3,"  s4 =",s4)

c1 = exp1((p-1)//3,g,p)
c2 = c1**2%p
t1 = (t3[0]+c1*t3[2]+c2*t3[4])%p
print("\n \n t1 = ",t1)

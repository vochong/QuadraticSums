...
s4 = [1678,1214,2068,1798,2219,37,846,57]
...
t1 = inverse(1,p)*(c1*t23+1*t24+c1*t25)%p
t2 = inverse(1,p)*(c2*t23+1*t24+c2*t25)%p
print("\n \n t1 = {0}  t2 = {1}".format(t1,t2))
print("\n \n")
...
t5 = h1[2]
c = 7
t15 = (t1*s1[c]+t2*s2[c]+t3*s3[c]+t4*s4[c]+t5*s5[c])%p
print("\n \n t15 = ",t15)
"""

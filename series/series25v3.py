...
h[0] = k1.series24(-l2,l2,[d[0]],d1*d1)
h[1] = k1.series24(-l2,l2,[d[1]],d1*d1)

h[2] = k2.series24(-l2,l2,[d[0]],d1*d1)
h[3] = k2.series24(-l2,l2,[d[1]],d1*d1)

h[4] = k3.series24(-l2,l2,[d[0]],d1*d1)
h[5] = k3.series24(-l2,l2,[d[1]],d1*d1)

e1 = 8*(p-1)//3
h[6] = k1.series24(-l2,l2,[d[0]],d1*d1)
h[7] = k1.series24(-l2,l2,[1*e1+d[1]],d1*d1)

h[8] = k1.series24(-l2,l2,[d[0]],d1*d1)
h[9] = k1.series24(-l2,l2,[2*e1+d[1]],d1*d1)

...
class group:
    ...
    def __init__(self,g,p): 
        ...
        "calc2","printlist","printlist2","printlist3","calc20","calc21",
        "calc23","calc24","calc25","calc27","calc28","calc29","list1","list2",
        "series_d","series_d1","series_d3","series_d20","hs20","hs21","hs",
        "ws","f1","f20","f21","calc32","f32","calc6","exp4b2","exp","h20",
        "series","series1","series3","series20","display","display2","display4")
    ...
    def calc20(self,a2,flag4,d1,q,p):
        ...
        if (flag4==1):
            ...
            self.printlist3(a,k2,d1,p)
        
        return(k2)

    def calc21(self,a2,flag4,d1,q,p):
        k2 = init2(24)
        if ((q%4)==0):
            t1 = q%12
            t2 = (q-t1)//12
    ...
    def calc24(self,a2,flag4,d1,q,p):
        k2 = init2(8)
        if ((q%4)==0):
            k2[0] = 1
            k2[1] = q//4-1
    ...
    def calc25(self,a2,flag4,d1,q,p):
        k2 = init2(10)
        t1 = q%5
        t2 = (q-t1)//5
        k2[0] = 1
    ...
    def calc27(self,a2,flag4,d1,q,p):
        k2 = init2(14)
        t1 = q%7
        t2 = (q-t1)//7
        k2[0] = 1
    ...
    def calc28(self,a2,flag4,d1,q,p):
        k2 = init2(16)
        if (q%8==4):
            t1 = q//4
            t2 = (t1-1)//2
    ...
    def calc29(self,a2,flag4,d1,q,p):
        k2 = init2(18)
        t1 = q%9
        t2 = (q-t1)//9
        k2[0] = 1
    ...
    def list1(self,n,d1,q):
        ...
        if n in a:
            if (n==3):
                k2 = k.calc23(k.a2,1,d1,q,k.p)
            if (n==4):
                k2 = k.calc24(k.a2,1,d1,q,k.p)
            if (n==5):
                k2 = k.calc25(k.a2,1,d1,q,k.p)
            if (n==6):
                k2 = k.calc20(k.a2,1,d1,q,k.p)
            if (n==7):
                k2 = k.calc27(k.a2,1,d1,q,k.p)
            if (n==8):
                k2 = k.calc28(k.a2,1,d1,q,k.p)
            if (n==9):
                k2 = k.calc29(k.a2,1,d1,q,k.p)                
            if (n==12):
                k2 = k.calc21(k.a2,1,d1,q,k.p)
...
class group2:
    ...
    def __init__(self,g,h,p): 
        ...
        self.functionlist = ("functions","variables","find2","find3","calc2",
        "series_d","series_d1","series_d3","series_d5","hs20","hs21","hs",
        "f1","f20","exp","series","series1","series3","series5",
        "display","display5")                     

...
void calc24d(integer a2[], int flag4, integer h15[], long int d1, integer q, integer p);
void calc25d(integer a2[], int flag4, integer k5[], long int d1, integer q, integer p);
void calc28d(integer a2[], int flag4, integer h15[], long int d1, integer q, integer p);
...
if((q%2)==1)
    ...
    h16[7] = h15[3];
    h16[8] = h15[4];
    h16[9] = h15[5]-(t-h15[2])+(t%2)-1;
    h16[10] = h15[5]-(t-h15[2])+(t%2);
    h16[11] = h15[5];
    }
...
if (flag4==1)
    ...
    for(i=0;i<8;i++)
        {
        series(h16[2*i],h16[2*i+1],a2,0,h14,d1,p);
        printf("\n i = %d  ",i);
        printf(" (%d , %d)  ",h16[2*i],h16[2*i+1]);
        displayh(2,h14);
        }
    }
}
...
if (flag4==1)
    ...
    for(i=0;i<8;i++)
        {
        series(k1[2*i],k1[2*i+1],a2,0,h14,d1,p);
        printf("\n i = %d  ",i);
        printf(" (%d , %d)  ",k1[2*i],k1[2*i+1]);
        displayh(2,h14);
        }

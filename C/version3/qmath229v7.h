...
void init142(int m2, int l2, int l3, integer a2[], integer hs1[], integer cs[], integer sn[],
...
void tuple1(int d, integer *str1, integer *str2, integer *str2a, int m2, int l2, int l3,
            ...
            STRING ptr2, integer b2[], integer p);
void init141(int m2, int l2, integer a2[], integer ws1[], integer hs1[], integer ws2[],
...
void equal2d(integer a1[], integer a2[]);
...
zero2a(144,e1,e1,ptr2);
zero2a(144,198,198,ptr2);
...
integer a5[2] = {0};
	...
	initcs(l2,a2,cs3,sn3,p);

	initcs(l3,a2,cs,sn,p);
	initcs1(l3,a2,cs1,sn1,p);
	initcs2(l3,a2,cs2,sn2,p);
...
/** in most cases d should equal 144 or 27 **/
/** 144 if hs1 = hs or 27 if hs1 = ws **/
...
*/
	...
	init142(m2,l2,l3,a3,hs1,cs,sn,h11,
...
integer h2[6] = {0,0,0,0,0,0};
	...
	initcs(l2,a2,cs,sn,p);
	initcs1(l2,a2,cs1,sn1,p);
	initcs2(l2,a2,cs2,sn2,p);
	...
	init138(m2,l2,a2,a20,a21,a22,ws1,hs1,ws2,hs2,cs,sn,h11,h12,
			 cs1,sn1,cs2,sn2,ptr2,b2,p);


	zero2a(m2,117,120,ptr2);
	zero2a(m2,131,132,ptr2);
	...
	if (flag_2==1)
		{
		printf("\n \n \n \n  l2 = %d",l2);
		printf("\n  in init141 (117,118) = (%d , %d)",b2[117],b2[118]);
		printf("\n  in init141 (119,120) = (%d , %d)",b2[119],b2[120]);
		printf("\n  in init141 (131,132) = (%d , %d)",b2[131],b2[132]);
		}
}
...
initcs(2*l2,a2,cs,sn,p);
initcs1(2*l2,a2,cs1,sn1,p);
initcs2(2*l2,a2,cs2,sn2,p);
...
for(i=0;i<d;i++)
	...
	init141(m2,2*l2,a3,ws1,hs1,ws2,hs2,cs,sn,cs1,sn1,cs2,sn2,h11,h12,
			 e1,flag0,ptr2,b2,p);

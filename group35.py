...
class group:
    ...
    def __init__(self,g,p): 
        ...
        "calc2","printlist","printlist2","calc20","calc21","calc23",
        "calc24","calc25","calc27","calc28","calc29","list1","list2",
    ...
    def f25(self,e1):
        ...
        a = e1[0]
        for i in range(9):
            t1 = (a[0*9+i]+(p-a[15*9+i]))%p
            c[i] = t1
            
            t1 = (a[4*9+i]+a[14*9+i])%p
            t2 = (a[2*9+i]+a[7*9+i])%p
            t2 = (p+t2)%p
            s[i] = (t1+t2)%p

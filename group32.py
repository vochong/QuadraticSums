...
class group:
    ...
    def __init__(self,g,p): 
        ...
        self.functions = ("list","variables","find2","find3","calc2",
        "series_d","series_d1","series_d3","series_d20","hs20","hs21","hs",
        "ws","f1","f20","f21","calc6","exp4b2","exp","h20","series","series1",
...
class group2:
    ...
    def __init__(self,g,h,p): 
        ...
        self.functions = ("list","variables","find2","find3","calc2",
                          "series_d","series_d1","series_d3","series_d5",
                          "hs20","hs21","hs","exp","series","series1",
                          "series3","series5","display","display5")                     
